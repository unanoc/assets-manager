				...
				Transactions: []Tx{
					{
						...
						ExplorerLink: fmt.Sprintf("%s/tx/%s", config.Default.ClientsURLs.BinanceExplorer, "hash"),
					},
				},
			},
		},
				...
				Transactions: []Tx{
					{
						...
						DestAddress:  "to_addr",
						FromAddress:  "from_addr",
						ExplorerLink: fmt.Sprintf("%s/tx/%s", config.Default.ClientsURLs.BinanceExplorer, "hash1"),
					},
					{
						Hash:         "hash2",
						Amount:       500,
						...
						DestAddress:  "to_addr",
						FromAddress:  "from_addr",
						ExplorerLink: fmt.Sprintf("%s/tx/%s", config.Default.ClientsURLs.BinanceExplorer, "hash2"),
					},
					{
						Hash:         "hash3",
						Amount:       500,
						...
						DestAddress:  "to_addr",
						FromAddress:  "from_addr",
						ExplorerLink: fmt.Sprintf("%s/tx/%s", config.Default.ClientsURLs.BinanceExplorer, "hash3"),
					},
				},
			},
		},
