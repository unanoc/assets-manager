				...
				Transactions: []Tx{
					{
						...
						ExplorerLink: fmt.Sprintf("%s/tx/%s", config.Default.Clients.Binance.Explorer, "hash"),
					},
				},
			},
		},
				...
				Transactions: []Tx{
					{
						...
						ExplorerLink: fmt.Sprintf("%s/tx/%s",
							config.Default.Clients.Binance.Explorer, "hash"),
					},
				},
			},
		},
				...
				Transactions: []Tx{
					{
						...
						FromAddress: "from_addr",
						ExplorerLink: fmt.Sprintf("%s/tx/%s",
							config.Default.Clients.Binance.Explorer, "hash1"),
					},
					{
						Hash:        "hash2",
						Amount:      500,
						...
						FromAddress: "from_addr",
						ExplorerLink: fmt.Sprintf("%s/tx/%s",
							config.Default.Clients.Binance.Explorer, "hash2"),
					},
					{
						Hash:        "hash3",
						Amount:      500,
						...
						FromAddress: "from_addr",
						ExplorerLink: fmt.Sprintf("%s/tx/%s",
							config.Default.Clients.Binance.Explorer, "hash3"),
					},
				},
			},
		},
