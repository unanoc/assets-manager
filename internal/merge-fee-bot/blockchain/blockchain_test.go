				...
				Transactions: []Tx{
					{
						...
						ExplorerLink: fmt.Sprintf("%s/tx/%s", config.Default.MergeFeeBot.ClientsURLs.BinanceExplorer, "hash"),
					},
				},
			},
		},
				...
				Transactions: []Tx{
					{
						...
						ExplorerLink: fmt.Sprintf("%s/tx/%s",
							config.Default.MergeFeeBot.ClientsURLs.BinanceExplorer, "hash"),
					},
				},
			},
		},
				...
				Transactions: []Tx{
					{
						...
						FromAddress: "from_addr",
						ExplorerLink: fmt.Sprintf("%s/tx/%s",
							config.Default.MergeFeeBot.ClientsURLs.BinanceExplorer, "hash1"),
					},
					{
						Hash:        "hash2",
						Amount:      500,
						...
						FromAddress: "from_addr",
						ExplorerLink: fmt.Sprintf("%s/tx/%s",
							config.Default.MergeFeeBot.ClientsURLs.BinanceExplorer, "hash2"),
					},
					{
						Hash:        "hash3",
						Amount:      500,
						...
						FromAddress: "from_addr",
						ExplorerLink: fmt.Sprintf("%s/tx/%s",
							config.Default.MergeFeeBot.ClientsURLs.BinanceExplorer, "hash3"),
					},
				},
			},
		},
